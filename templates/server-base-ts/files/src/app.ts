...
// Order matters and is the whole point of these two lines: nothing matched, then nothing else
// can handle the error. The error handler is last in the chain, always.
app.use(notFound);
